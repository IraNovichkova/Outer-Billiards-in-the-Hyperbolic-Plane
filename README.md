...
Я написала курсовую работу о внешних бильярдах на третьем курсе матфака НИУ ВШЭ. Работа была довольно творческой, так как мне нужно было самостоятельно исследовать отображение и сформулировать гипотезы. Одну из гипотез я доказала, остальные планирую рассмотреть на четвёртом курсе.

В курсовой работе я использовала 2 составляющие:
- математику: ТФКП;
- python: написала код с библиотекой PIL для визуализации бильярда.

В этом проекте я опишу математическую составляющую без доказательств, оставив только ту часть, которая необходима для понимания внешнего бильярда и моего кода.
